...
This repository contains the source codes for a To Do List Website. It showcases my skills and expertise in creating Objects with Classes, Sectioning with Modules and using Add Event Listeners. I used HTML, CSS and Javascript programming languages in the creation of this project.
...
- **Add Functionality:A User is able to add a new to-do-task**
- **Remove Functionality: A user is able to remove added to-do-task**
- **Edit Functionality:A User is able to edit already added to-do-task**
- **Clear All Functionality: A user is able to clear all completed to-do-tasks**
...
```sh
  cd my-folder
  git@github.com:Ayokunnumi1/To-Do-List-App.git
```
